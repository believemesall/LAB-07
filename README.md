...
Hello!	| ใช้ไม่ได้|	มีเครื่องหมายทางคณิตศาสตร์อยู่ในชื่อ
w*h 	| ใช้ไม่ได้|	มีเครื่องหมายทางคณิตศาสตร์อยู่ในชื่อ		
time	| ใช้ได้|			
do	| ใช้ได้|			
Do	| ใช้ได้|			
21November	| ใช้ไม่ได้|	มีตัวเลข		
ladkrabang	| ใช้ได้|			
Student ID	| ใช้ไม่ได้|	เว้นวรรค		
...
<img src = "https://github.com/believemesall/LAB-07/blob/master/LAB7.PNG">
<img src = "https://github.com/believemesall/LAB-07/blob/master/LAB7.1.PNG">
**หมายเหตุ**
...
<img src = "https://github.com/believemesall/LAB-07/blob/master/LAB7.2.PNG">
